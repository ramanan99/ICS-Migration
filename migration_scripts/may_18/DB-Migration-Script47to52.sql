...
#alter table ManagedGroupObject drop column OWNERNAME;
...
alter table PhysicalEntity drop primary key;
...
alter table PhysicalContainer drop primary key;
...
alter table PhysicalElement drop primary key;
...
alter table PhysicalSubUnit drop primary key;
...
alter table PhysicalUnit drop primary key;
...
alter table LogicalContainer drop primary key;
...
alter table LogicalElement drop primary key;
...
alter table LogicalUnit drop primary key;
...
alter table ProtectionGroup drop primary key;
...
alter table SBNE drop primary key;
...
alter table NetworkElementManagement drop primary key;
...
alter table DataObject drop primary key;
...
alter table IpConfig drop primary key;
...
alter table EventControl drop primary key;
...
alter table RelationObject drop primary key;
...
alter table PhysicalUnitStream drop primary key;
...
alter table LogicalUnitStream drop primary key;
...
alter table LogStreamDataConfig drop primary key;
...
alter table LogStream drop primary key;
...
alter table Constituent drop primary key;
...
alter table ConnectivityData drop primary key;
...
alter table Interface drop primary key;
...
alter table InterfaceContainer drop primary key;
...
alter table Endpoint drop primary key;
...
alter table BlackBoxLogStream drop primary key;
...
alter table CoreFileMgmtLogStream drop primary key;
...
alter table HapNeControl drop primary key;
...
alter table CnpEthernetPortGroup drop primary key;
...
alter table CnpFileSystemInfo drop primary key;
...
alter table CnpRaidPortGroup drop primary key;
...
alter table CnpServerInfo drop primary key;
...
alter table CnpEthernetPort drop primary key;
...
alter table CnpRaidPort drop primary key;
...
alter table CnpCageInfo drop primary key;
...
alter table CnpACL drop primary key;
...
alter table CnpFruInfo drop primary key;
...
alter table CnpSystemInfo drop primary key;
...
alter table CnpLocationInfo drop primary key;
...
alter table CnpMonDevInfo drop primary key;
...
alter table CnpCage drop primary key;
...
alter table CnpClusterManager drop primary key;
...
alter table CnpClusterManagerPG drop primary key;
...
alter table CnpEmsServer drop primary key;
...
alter table CnpEmsServerPG drop primary key;
...
alter table CnpExtSwitch drop primary key;
...
alter table CnpFan drop primary key;
...
alter table CnpPEM drop primary key;
...
alter table CnpRaid drop primary key;
...
alter table CnpRaidController drop primary key;
...
alter table CnpRaidFan drop primary key;
...
alter table CnpRaidLogicalDrive drop primary key;
...
alter table CnpRaidLogicalUnit drop primary key;
...
alter table CnpRaidPEM drop primary key;
...
alter table CnpRaidPhysicalDrive drop primary key;
...
alter table CnpShmm drop primary key;
...
alter table CnpSwitch drop primary key;
...
alter table CnpTermServer drop primary key;
...
alter table CnpSwitchUnit drop primary key;
...
alter table CnpRTM drop primary key;
...
alter table BlackBoxDataConfig drop primary key;
...
alter table CnpAirFilter drop primary key;
...
alter table CnpSystemAlarmPanel drop primary key;
...
alter table CnpShelfEEPROM drop primary key;
...
alter table CnpShmmBMC drop primary key;
...
alter table CnpEmsSensor drop primary key;
...
# alter table for CnpThirdPartyAppServer
SELECT 'STEP 111 : alter CnpThirdPartyAppServer table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table CnpThirdPartyAppServer drop primary key;
alter table CnpThirdPartyAppServer drop column OWNERNAME;
alter table CnpThirdPartyAppServer add column MOID bigint(20) first;
update CnpThirdPartyAppServer set moid = (select moid from ManagedObject where CnpThirdPartyAppServer.name = ManagedObject.name);
alter table CnpThirdPartyAppServer add primary key (MOID);
alter table CnpThirdPartyAppServer add constraint `FKF75D840E1798EF8` FOREIGN KEY (`MOID`) REFERENCES `ManagedObject` (`MOID`) ON DELETE CASCADE;
alter table CnpThirdPartyAppServer drop column NAME;
# index creation for CnpThirdPartyAppServer
create index `FKF75D840E1798EF8` on CnpThirdPartyAppServer(MOID);
# alter table for CnpExternalServer
SELECT 'STEP 112 : alter CnpExternalServer table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table CnpExternalServer drop primary key;
...
SELECT 'STEP 113 : alter EnumServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table EnumServerLink drop primary key;
...
SELECT 'STEP 114 : alter SubLdapServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SubLdapServerLink drop primary key;
...
SELECT 'STEP 115 : alter PeerMMSCLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table PeerMMSCLink drop primary key;
...
SELECT 'STEP 116 : alter SmppServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmppServerLink drop primary key;
...
SELECT 'STEP 117 : alter SmtpServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmtpServerLink drop primary key;
...
SELECT 'STEP 118 : alter TranscoderLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table TranscoderLink drop primary key;
...
SELECT 'STEP 119 : alter VaspLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table VaspLink drop primary key;
...
SELECT 'STEP 120 : alter Mm1Link table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table Mm1Link drop primary key;
...
SELECT 'STEP 121 : alter BackupServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table BackupServerLink drop primary key;
...
SELECT 'STEP 122 : alter PrepaidServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table PrepaidServerLink drop primary key;
...
SELECT 'STEP 123 : alter TapLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table TapLink drop primary key;
...
SELECT 'STEP 124 : alter MateLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table MateLink drop primary key;
...
SELECT 'STEP 125 : alter Ss7PCLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table Ss7PCLink drop primary key;
...
SELECT 'STEP 126 : alter SmtpClientLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmtpClientLink drop primary key;
...
SELECT 'STEP 127 : alter SmppClientLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmppClientLink drop primary key;
...
SELECT 'STEP 128 : alter Ss7AssociationLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table Ss7AssociationLink drop primary key;
...
SELECT 'STEP 129 : alter BillingServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table BillingServerLink drop primary key;
...
SELECT 'STEP 130 : alter MsgArchiveServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table MsgArchiveServerLink drop primary key;
...
SELECT 'STEP 131 : alter DnsServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table DnsServerLink drop primary key;
...
SELECT 'STEP 132 : alter AckFwdSystemLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table AckFwdSystemLink drop primary key;
...
SELECT 'STEP 133 : alter ExternalIPLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table ExternalIPLink drop primary key;
...
SELECT 'STEP 134 : alter EsmeLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table EsmeLink drop primary key;
...
SELECT 'STEP 135 : alter SmscLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmscLink drop primary key;
...
SELECT 'STEP 136 : alter TapClientLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table TapClientLink drop primary key;
...
SELECT 'STEP 137 : alter XmlClientLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table XmlClientLink drop primary key;
...
SELECT 'STEP 138 : alter InterMateLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table InterMateLink drop primary key;
...
SELECT 'STEP 139 : alter EsmeNetworkConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table EsmeNetworkConnectionLink drop primary key;
...
SELECT 'STEP 140 : alter EsmeQueuedMessageLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table EsmeQueuedMessageLink drop primary key;
...
SELECT 'STEP 141 : alter LnpServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table LnpServerLink drop primary key;
...
SELECT 'STEP 142 : alter EsmeLocalConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table EsmeLocalConnectionLink drop primary key;
...
SELECT 'STEP 143 : alter SmscLocalConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmscLocalConnectionLink drop primary key;
...
SELECT 'STEP 144 : alter SmscNetworkConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmscNetworkConnectionLink drop primary key;
...
SELECT 'STEP 145 : alter SmscQueuedMessageLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmscQueuedMessageLink drop primary key;
...
SELECT 'STEP 146 : alter TapLocalConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table TapLocalConnectionLink drop primary key;
...
SELECT 'STEP 147 : alter TapNetworkConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table TapNetworkConnectionLink drop primary key;
...
SELECT 'STEP 148 : alter XmlcLocalConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table XmlcLocalConnectionLink drop primary key;
...
SELECT 'STEP 149 : alter XmlcNetworkConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table XmlcNetworkConnectionLink drop primary key;
...
SELECT 'STEP 150 : alter LoadBalancerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table LoadBalancerLink drop primary key;
...
SELECT 'STEP 151 : alter BmgwServerThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table BmgwServerThrottleLink drop primary key;
...
SELECT 'STEP 152 : alter BmgwServerUnavailableLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table BmgwServerUnavailableLink drop primary key;
...
SELECT 'STEP 153 : alter UsageControlServiceLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table UsageControlServiceLink drop primary key;
...
SELECT 'STEP 154 : alter DiskUsage table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table DiskUsage drop primary key;
...
SELECT 'STEP 155 : alter FileSystem table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table FileSystem drop primary key;
...
SELECT 'STEP 156 : alter HssServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table HssServerLink drop primary key;
...
SELECT 'STEP 157 : alter HssServerUnavailableConnection table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table HssServerUnavailableConnection drop primary key;
...
SELECT 'STEP 158 : alter ImsGsmGwServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table ImsGsmGwServerLink drop primary key;
...
SELECT 'STEP 159 : alter ImsGsmGwServerThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table ImsGsmGwServerThrottleLink drop primary key;
...
SELECT 'STEP 160 : alter SCSCFServerThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SCSCFServerThrottleLink drop primary key;
...
SELECT 'STEP 161 : alter HssServerThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table HssServerThrottleLink drop primary key;
...
SELECT 'STEP 162 : alter ContentAdaptationLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table ContentAdaptationLink drop primary key;
...
SELECT 'STEP 163 : alter SmtpLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmtpLink drop primary key;
...
SELECT 'STEP 164 : alter SmtpLocalConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmtpLocalConnectionLink drop primary key;
...
SELECT 'STEP 165 : alter SmtpNetworkConnectionLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmtpNetworkConnectionLink drop primary key;
...
SELECT 'STEP 166 : alter SmtpQueuedMessageLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SmtpQueuedMessageLink drop primary key;
...
SELECT 'STEP 167 : alter StatSizeAuditLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table StatSizeAuditLink drop primary key;
...
SELECT 'STEP 168 : alter CapacityLicenseLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table CapacityLicenseLink drop primary key;
...
SELECT 'STEP 169 : alter PersonalizationConfig table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table PersonalizationConfig drop primary key;
...
SELECT 'STEP 170 : alter SpamServerLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SpamServerLink drop primary key;
...
SELECT 'STEP 171 : alter SpamServerThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SpamServerThrottleLink drop primary key;
...
SELECT 'STEP 172 : alter SpamServerUnavailableConnection table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SpamServerUnavailableConnection drop primary key;
...
SELECT 'STEP 173 : alter PrepaidServerThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table PrepaidServerThrottleLink drop primary key;
...
SELECT 'STEP 174 : alter M2paLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table M2paLink drop primary key;
...
SELECT 'STEP 175 : alter M2paLogicalUnit table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table M2paLogicalUnit drop primary key;
...
SELECT 'STEP 176 : alter M2paSystemInfo table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table M2paSystemInfo drop primary key;
...
SELECT 'STEP 177 : alter GeoRedSMSReplLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table GeoRedSMSReplLink drop primary key;
...
SELECT 'STEP 178 : alter GeoRedSMSReplThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table GeoRedSMSReplThrottleLink drop primary key;
...
SELECT 'STEP 179 : alter RemoteSMSCThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table RemoteSMSCThrottleLink drop primary key;
...
SELECT 'STEP 180 : alter MsmMemUtilization table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
...
SELECT 'STEP 181 : alter MsgBladeLU table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table MsgBladeLU drop primary key;
...
SELECT 'STEP 182 : alter MsgBladeLUContainer table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table MsgBladeLUContainer drop primary key;
...
SELECT 'STEP 183 : alter ClassOfService table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table ClassOfService drop primary key;
...
SELECT 'STEP 184 : alter EnumServiceLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table EnumServiceLink drop primary key;
...
SELECT 'STEP 185 : alter Ss7Service table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table Ss7Service drop primary key;
...
SELECT 'STEP 186 : alter Congestion table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table Congestion drop primary key;
...
SELECT 'STEP 187 : alter MessagingSystem table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table MessagingSystem drop primary key;
...
SELECT 'STEP 188 : alter StatisticsThreshold table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table StatisticsThreshold drop primary key;
...
SELECT 'STEP 189 : alter QueueOverflow table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table QueueOverflow drop primary key;
...
SELECT 'STEP 190 : alter BmgwClientThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table BmgwClientThrottleLink drop primary key;
...
SELECT 'STEP 191 : alter ImsGsmGwClientThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table ImsGsmGwClientThrottleLink drop primary key;
...
SELECT 'STEP 192 : alter SCSCFClientThrottleLink table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table SCSCFClientThrottleLink drop primary key;
...
SELECT 'STEP 193 : alter MpSystemConfig table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table MpSystemConfig drop primary key;
...
SELECT 'STEP 194 : alter CnpPSBlackBoxLS table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table CnpPSBlackBoxLS drop primary key;
...
SELECT 'STEP 195 : alter CnpPSCoreFileMgmtLS table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table CnpPSCoreFileMgmtLS drop primary key;
...
SELECT 'STEP 196: alter CnpPayloadServer table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table CnpPayloadServer drop primary key;
...
SELECT 'STEP 197 : alter CnpPayloadServerPG table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table CnpPayloadServerPG drop primary key;
...
SELECT 'STEP 198 : alter CnpPSBlackBoxDC table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
alter table CnpPSBlackBoxDC drop primary key;
...
SELECT 'STEP 199 : alter TOPOUSERPROPS table to change pk and populate MOID' AS 'MIGRATION PROCESS STATUS ... ';
...
SELECT 'STEP 200 : alter ObjectSchedulerRUNNABLE table to add CLASSNAME & MOID column' AS 'MIGRATION PROCESS STATUS ... ';
...
SELECT 'STEP 201 : drop OWNERNAME and MEMBEROWNERNAME columns in GroupTable table' AS 'MIGRATION PROCESS STATUS ... ';
...
SELECT 'STEP 202 : drop redundant tables in Fault Management module' AS 'MIGRATION PROCESS STATUS ... ';
...
SELECT 'STEP 203 : alter Event table' AS 'MIGRATION PROCESS STATUS ... ';
alter table Event drop column DDOMAIN;
alter table Event drop column HELPURL;
alter table Event drop column OWNERNAME;
alter table Event add column DISCRIMINATOR varchar(30) NOT NULL after `ID`;
#update Event set DISCRIMINATOR = (select VALUESTRING from DBEVENT where ID=KEYSTRING);
...
SELECT 'STEP 204 : drop DBEVENT table' AS 'MIGRATION PROCESS STATUS ... ';
drop table if exists DBEVENT;
# alter table for CNEOMIManagementEvent
SELECT 'STEP 205 : alter CNEOMIManagementEvent table to change pk and populate ID' AS 'MIGRATION PROCESS STATUS ... ';
...
SELECT 'STEP 216 : Move content of PanelProps table to PanelTree.PANELPROPS and drop PanelProps table' AS 'MIGRATION PROCESS STATUS ... ';
